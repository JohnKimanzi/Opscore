        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Completed Appraisals</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active">Completed Appraisal</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <table id="table" class="table table-striped custom-table mb-0">
                            ...
                            @foreach ($appraisals as $appraisal)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('my_results',[$appraisal->id])}}" class="btn btn-primary btn-sm text-light">View</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
