          ...
          <div class="tab-content profile-tab-content">
            ...
            <div v-if="step === 1">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    <label class="col-form-label"
                      >Contract Expiry Date<span class="text-danger"
                        >*</span
                      ></label
                    >
                    <input
            ...
            <div v-if="step === 7">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <label class="col-form-label">Language 4</label>
                    <input
                      v-model="language4"
                      class="form-control"
                      name="language4"
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <label class="col-form-label">Language 5</label>
                    <input
                      v-model="language5"
                      class="form-control"
                      name="language5"
...
export default {
  ...
  mounted() {
    this.language1 = this.current.langs.language1;
    this.language2 = this.current.langs.language2;
    this.language3 = this.current.langs.language3;
    this.language4 = this.current.langs.language4;
    this.language5 = this.current.langs.language5;
    ...
    this.currency = this.current.currency_id;
    ...
    this.disabilityStatus = this.current.disability;
    this.disabilityDetails = this.current.disability_details;
    this.healthStatus = this.current.health;
    this.healthDetails = this.current.health_details;
    this.educationLevelsDataArray = this.current.educations;
    this.nextOfKinArray = this.current.next_of_kins;
    this.phone1 = this.current.phone1;
    this.phone2 = this.current.phone2;

    this.current.next_of_kins.forEach(kin => {
        this.addNextOfKin(kin.full_name, kin.relationship, kin.phone1);
    });
    this.current.educations.forEach(edu => {
      this.addEducationLevel(
  ...
  methods: {
    ...
    addEducationLevel(level=null, institute=null, fos=null, estart=null, eend=null ) {
      this.educationLevelsDataArray.push({
        educationLevels: level,
        educationInstitution: institute,
        educationFieldOfStudy: fos,
        educationStart: estart,
        educationEnd: eend,
      });
    },
    gotToBankDetails() {
    ...
    addNextOfKin(name=null, relationship=null, phone=null) {
    ...
    editEmployee() {
      if (!this.language1) {
        this.$message.error("Please enter language 1");
      } else if (!this.language2) {
        this.$message.error("Please enter language 2");
      } else if (!this.language3) {
        this.$message.error("Please enter language 3");
      } else {
        ...
        formData.append("language3", this.language3);
        formData.append("language4", this.language4);
        formData.append("language5", this.language5);
        ...
        formData.append("nextOfKins", JSON.stringify(this.nextOfKinArray));
        ...
        axios
          .post("/employees/" + this.current.id, formData, config)
          .then((resp) => {
