                ...
                <div class="tab-content profile-tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select  v-model="gender" class="form-control" required name="gender_id">
                             ...
                             <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select  v-model="marital_status" class="form-control" required name="marital_status_id">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input  v-model="workEmail"  class="form-control"  required  autocomplete="username"  type="email" autofocus >
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="col-form-label">Personal Email<span class="text-danger">*</span></label>
                                    <input v-model="personalEmail" class="form-control"  required  autocomplete="username"  type="email" autofocus >
                  ...
                  <div class="form-group">
                    ...
                    <vue-phone-number-input
                      ...
                      color="#FF0000"
                      :only-countries="['KE','UG','TZ','MW','GH','ET','ZM']"
                    ></vue-phone-number-input>
                  </div>
                </div>
                <div class="col-sm-6">
  ...
  methods: {
    ...
    goToStatutoryDetails() {
      if (!this.contract) {
        ...
        this.$message.error("Please select the Currency.");
        ...
        this.$message.error("Please select team.");
      }else {
        this.step = 2;
      }
    },
