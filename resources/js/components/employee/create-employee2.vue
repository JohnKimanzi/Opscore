                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select  v-model="gender" class="form-control" required name="gender">
                                        <option :value="gender.id" v-for="(gender,index) in genderData" :key="index">{{gender.name}}</option>
                                    </select>
                                </div>
                            </div>
                                   <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select  v-model="marital_status" class="form-control" required name="marital_status">
                                        <option :value="marital_status.id" v-for="(marital_status,index) in marital_statusData" :key="index">{{marital_status.name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select v-model="country" class=" form-control" required name="country_id">
                                        <option :value="country.id" v-for="(country,index) in countryData" :key="index">{{country.name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="contract" class="form-control" required name="contract">
                                        <option :value="contract.id" v-for="(contract,index) in contracts" :key="index">{{contract.type}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="department" class="form-control" required name="department">
                                        <option :value="department.id" v-for="(department,index) in departmentData" :key="index">{{department.name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="designation" class="form-control" required name="designation">
                                        <option :value="designation.id" v-for="(designation,index) in designationData" :key="index">{{designation.name}}</option>
                                    </select>
                                </div>
                            </div>
                             <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="project" class="form-control" required name="project">
                                        <option :value="project.id" v-for="(project,index) in projectData" :key="index">{{project.name}}</option>
                                        {{dd('project')}}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="report_to" class="form-control" required name="designation">
                                        <option :value="employee.id" v-for="(employee,index) in employeeData" :key="index">{{employee.first_name}} {{employee.middle_name}} {{employee.last_name}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  v-model="input.educationLevel" class="form-control" required name="educationLevel">
                                        <option :value="level.id" v-for="(level,index) in educationLevelsData" :key="index">{{level.name}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select  v-model="bloodGroup" class="form-control" required name="level">
                                        <option :value="group.id" v-for="(group,index) in bloodGroupsData" :key="index">{{group.name}}</option>
                                    </select>
                                </div>
                            </div>
...
export default {
    ...
    methods:{
        ...
        goToContractDetails(){
             ...
             if (!this.fName){
                this.$message.error('Please enLanguageter first name.');
            }
            else if (!this.mName){
       ...
       createEmployee(){
            if (this.workEmail.length <=0){
                this.$message.error('Please enter valid Work email')
